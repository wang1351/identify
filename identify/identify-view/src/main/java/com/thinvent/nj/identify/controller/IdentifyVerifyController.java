...
*/
@Controller
@RequestMapping(path = "/identifies/verify")
public class IdentifyVerifyController extends BaseViewController {
    ...
    public ResponseEntity insert(@RequestBody Map<String, Object> params) {
        ...
        identifyVerifyService.insert(params);
